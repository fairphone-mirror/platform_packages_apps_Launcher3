...
public class SecondarySystemUIProxy implements ISystemUiProxy, SafeCloseable{
    private static final String TAG = SecondarySystemUIProxy.class.getSimpleName();

    public static final MainThreadInitializedObject<SecondarySystemUIProxy> INSTANCE =
            new MainThreadInitializedObject<>(SecondarySystemUIProxy::new);
    ...
    public SecondarySystemUIProxy(Context context) {
        mContext = context;
    ...
    public void setProxy(ISystemUiProxy proxy, IPip pip, IBubbles bubbles, ISplitScreen splitScreen,
        ...
        setLauncherUnlockAnimationController(mLauncherActivityClass, mLauncherUnlockAnimationController);
